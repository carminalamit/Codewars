...
// Convert the animal argument to lowercase to make the comparison case-insensitive.
// Check if the lowercase animal is equal to "alligator".
// If it is, return "small".
// If it is not, return "wide".
