...
// we use a for loop and check each element in the array to see if it is consecutive
// with the previous element. If an element is found that is not consecutive, return it.
